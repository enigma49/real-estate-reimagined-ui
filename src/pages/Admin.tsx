...
const Admin = () => {
  ...
  // Mock data
  const stats = [
    { title: 'Total Properties', value: '1,234', change: '+12%', icon: HomeIcon, color: 'text-blue-600' },
  ...
  const recentProperties = [
    { id: 1, title: 'Modern Downtown Condo', location: 'San Francisco, CA', price: '$850,000', status: 'Active', date: '2024-01-15' },
    { id: 2, title: 'Family Home with Garden', location: 'Austin, TX', price: '$425,000', status: 'Pending', date: '2024-01-14' },
    { id: 3, title: 'Luxury Beachfront Villa', location: 'Miami, FL', price: '$2,100,000', status: 'Active', date: '2024-01-13' },
    { id: 4, title: 'Cozy Mountain Cabin', location: 'Denver, CO', price: '$320,000', status: 'Sold', date: '2024-01-12' },
  ];
